...
CREATE TABLE IF NOT EXISTS events (
    ...
    event_type TEXT NOT NULL,          -- resource_sample | process_start | process_end | command_run | git_commit | git_checkout | tab_opened | tab_closed | tab_focus | tab_updated | file_saved | code_snapshot | execution_result
